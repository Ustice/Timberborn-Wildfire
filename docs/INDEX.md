...
- [Inactive fertilizer recovery](qa/fertilizer-satchel-recovery-prototype.md): inventory-derived return, verified native root priority, bounded cancellation and unblocked destination access; registration, full reload and movement remain activation gates.
