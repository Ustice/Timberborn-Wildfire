...
- [Inactive natural-water ownership](qa/native-water-ownership-component.md): native buffered volume remains authoritative; persisted source identity and exact scheduled credit observation reject ambiguous ownership. Actual [factory arming, finite removal and positive-buffer restore](qa/native-water-source-factory.md) pass together in CPU Unity; full fluid scheduling, bucket delivery and full-game persistence remain open.
...
- [Borrowed-water recovery](qa/borrowed-water-return-recovery.md): an inactive persistent return assignment uses native arbitration and reserves capacity only at arrival; complete firefighter travel and actor restore remain open.
