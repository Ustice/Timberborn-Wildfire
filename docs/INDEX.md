...
- [Reserved water return](qa/warden-reserved-return.md): a concrete private-bucket return preserves native inventory accounting and validates capacity-release callbacks; positive public owner liveness and physical recovery still require engine proof.
