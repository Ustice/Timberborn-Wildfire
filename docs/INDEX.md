...
- [Incomplete dispatch safety](qa/legacy-dispatch-fail-stop.md): authoritative step outcomes prevent saves and further dispatch after escaping failures interrupt committed world effects; legacy swallowed failures and whole-dispatch save exclusion remain separate gaps.
