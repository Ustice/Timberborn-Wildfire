...
- [Inactive natural-water ownership](qa/native-water-ownership-component.md): native buffered volume remains authoritative; persisted source identity and exact scheduled credit observation reject ambiguous ownership. Successful source arming, positive-buffer engine restore and bucket delivery remain open.
