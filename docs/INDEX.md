...
- [Inactive natural-water ownership](qa/native-water-ownership-component.md): native buffered volume remains authoritative; persisted source identity and exact scheduled credit observation reject ambiguous ownership. Actual [factory arming and finite positive-buffer restore](qa/native-water-source-factory.md) pass in CPU Unity; fluid integration, bucket delivery and full-game persistence remain open.
