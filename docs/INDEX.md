...
- [Soil authority correction](qa/tainted-ash-soil-authority.md): the old rendering-only hook is removed; native soil poisoning reports unavailable until a verified native source integration exists.
