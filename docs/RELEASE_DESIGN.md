...
- A GPU fire simulation tracks fuel, heat, flammability, water, terrain, atmospheric fields, and companion material metadata.
...
| Material | Fuel | Flammability | Water | Burn capacity | Consequence target | Ash |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| terrain | 0 | 0 | 0 | 0 | none | none |
| vegetation | 10 | 3 | 0 | 10 | tree | fertile |
| crop | 4 | 2 | 0 | 4 | crop | fertile |
| tree | 12 | 2 | 0 | 12 | tree | fertile |
| building | 15 | 1 | 0 | 15 | structure | fertile |
| storage | 8 | 2 | 0 | 8 | storage | fertile |
| infrastructure | 0 | 0 | 0 | 0 | infrastructure | fertile |
| water | 0 | 0 | 3 | 0 | water | none |
...
The runtime binds the visual field surface when a compute simulator is available and exposes counters for readiness and live diagnostics.
