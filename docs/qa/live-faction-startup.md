...
Folktails succeeded: native world loading took 6,692 ms, the GPU runtime became ready, and the fresh colony visibly contained nine adults and four kits with its starting food/water. Ordinary dispatch reached tick 33 without a runtime exception. `Wildfire Folktails QA 2026-09-07 / Healthy start 8cbeb19.timber` was saved and backed up before leaving. This is a healthy starting fixture, not a sustained colony or worker/fire workflow proof. The exposure dispatcher's tracked-state count was zero; this observation alone does not establish that native beavers were missing from enumeration.
