...
| Native warden station, equipment, sortie, route safety and water commit | `src/Wildfire.Timberborn/FireResponse/` | `tests/Wildfire.Timberborn.Tests/WardenSortieTests.cs`, `tests/Wildfire.Timberborn.Tests/WardenRouteSafetyTests.cs`, `tests/Wildfire.Timberborn.Tests/WardenDeliveryTransactionTests.cs`; [live acceptance](qa/warden-native-prototype.md) |
