...
| Read-only initial native body, named yield and physical stock capture | `src/Wildfire.Timberborn/Runtime/TimberbornInitialWorldProjectionProvider.cs`, `src/Wildfire.Timberborn/Mapping/TimberbornInitialMaterialCapture.cs` | `tests/Wildfire.Timberborn.Tests/InitialNativeMaterialCaptureTests.cs`; composition and production activation remain pending |
