...
| Complete owned consequence history and staged world restoration | `src/Wildfire.Timberborn/Persistence/TimberbornOwnedConsequenceSnapshot.cs`, `src/Wildfire.Timberborn/Persistence/TimberbornOwnedWorldSession.cs`, `src/Wildfire.Timberborn/Consequences/Owned/` | `tests/Wildfire.Timberborn.Tests/OwnedConsequenceHistoryCodecTests.cs`, `tests/Wildfire.Timberborn.Tests/OwnedWorldSessionTests.cs`; [native history proof](qa/owned-consequence-history.md) |
