...
| Shared GPU encoding, queue, tick ordering and failure stages | `src/Wildfire.Core/FireSimGpuProtocol.cs`, `src/Wildfire.Core/FireSimChangeQueue.cs`, `src/Wildfire.Core/FireSimStepCoordinator.cs` | `tests/Wildfire.Core.Tests/FireSimGpuProtocolTests.cs`, `tests/Wildfire.Core.Tests/FireSimStepCoordinatorTests.cs` |
...
| QA command bridge, target selection, stimuli and proof | `src/Wildfire.Timberborn/Qa/TimberbornQaController.cs`, `src/Wildfire.Timberborn/Qa/TimberbornQaTargetSelector.cs`, `src/Wildfire.Timberborn/Qa/TimberbornQaCommandBridge.cs` | `tests/Wildfire.Timberborn.Tests/TimberbornQaCommandBridgeTests.cs` |
