...
- Coordinator reconciliation 2026-05-01:
   - Moved to done after `TWF-023` unblocked the compute bundle package and live Timberborn initialized `TimberbornComputeFireSimulatorFactory`.
   - Accepted evidence includes `wildfire_timberborn_compute_asset_loaded`, `wildfire_timberborn_gpu_simulator_created width=128 height=128 depth=23`, and `wildfire_timberborn_runtime_simulator_initialized width=128 height=128 depth=23`.
