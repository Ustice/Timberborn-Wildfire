...
- 2026-05-04 live Diorama proof showed the original live initializer ran before entity data was available: first reload after entity-provider wiring reported `safe_unavailable=0` but still only terrain. The initializer now waits for `EntityRegistry` population before importing, with a terrain-only fallback for empty maps.
- 2026-05-04 live proof on `Wildfire Diorama 50 QA` passed after redeploy/reload: `qa-readiness` reported `width=50`, `height=50`, `depth=23`, `world_import_total_sources=4288`, `world_import_terrain_sources=2503`, `world_import_tree_sources=1305`, `world_import_building_sources=335`, `world_import_storage_sources=23`, `world_import_water_sources=32`, `world_import_badwater_sources=90`, and `world_import_safe_unavailable=0`.
