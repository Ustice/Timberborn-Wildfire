...
def main():
    ...
    try:
        ...
        for marker in ['WILDFIRE_MATERIAL_SNAPSHOT_PROBE_PASS','WILDFIRE_GPU_EXHAUSTION_RESTORE_PASS','WILDFIRE_FIRST_SLOT_ACTIVATION_PASS','WILDFIRE_DELTA_SLOT_PROVENANCE_PASS']:
