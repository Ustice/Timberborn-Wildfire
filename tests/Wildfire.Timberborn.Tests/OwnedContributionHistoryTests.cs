...
public sealed partial class OwnedWorldSessionTests
{
    ...
    {
        var together=new F(); var split=new F(); var stock=together.Registrations[2].EntityId;
        ...
        var native=new F(); native.Native.Amounts[stock]=split.Native.Amounts[stock]; // Native inventory save is authority.
