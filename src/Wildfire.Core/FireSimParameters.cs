...
public readonly record struct FireSimParameters(
    ...
    uint FireRetainedHeatWeight,
    uint FireSpreadHeatWeight,
    uint FireBurningNeighborHeatBonus,
    uint FireBurningNeighborDirectHeat,
    uint FireWaterSuppressionHeat,
    ...
    uint FireFuelBurnDownRollSeed)
{
    public static readonly FireSimParameters Default = new(
        ...
        FireSpreadHeatWeight: 1u,
        FireBurningNeighborHeatBonus: 5u,
        FireBurningNeighborDirectHeat: 1u,
        FireWaterSuppressionHeat: 2u,
