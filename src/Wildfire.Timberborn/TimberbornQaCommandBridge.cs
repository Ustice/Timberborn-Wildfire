...
public sealed record TimberbornQaCommandState(
    ...
    bool BeaverHazardAvoidanceEnabled = false,
    int? BeaverHazardAvoidanceObservedHazardCells = null,
    int? BeaverHazardAvoidanceRestrictedCells = null,
    int? BeaverHazardAvoidanceAppliedRestrictions = null,
    int? BeaverHazardAvoidanceReleasedRestrictions = null,
    int? BeaverHazardAvoidanceSkippedNoSafeApi = null,
    int? BeaverHazardAvoidanceFailedRestrictions = null,
    uint? BeaverHazardAvoidanceLastUpdatedTick = null,
    ...
    string Message)
{
    public string ResultToken =>
        ...
        $"beaver_hazard_avoidance_enabled={State.BeaverHazardAvoidanceEnabled.ToString().ToLowerInvariant()} " +
        $"beaver_hazard_avoidance_observed_hazard_cells={FormatNumber(State.BeaverHazardAvoidanceObservedHazardCells)} " +
        $"beaver_hazard_avoidance_restricted_cells={FormatNumber(State.BeaverHazardAvoidanceRestrictedCells)} " +
        $"beaver_hazard_avoidance_applied_restrictions={FormatNumber(State.BeaverHazardAvoidanceAppliedRestrictions)} " +
        $"beaver_hazard_avoidance_released_restrictions={FormatNumber(State.BeaverHazardAvoidanceReleasedRestrictions)} " +
        $"beaver_hazard_avoidance_skipped_no_safe_api={FormatNumber(State.BeaverHazardAvoidanceSkippedNoSafeApi)} " +
        $"beaver_hazard_avoidance_failed_restrictions={FormatNumber(State.BeaverHazardAvoidanceFailedRestrictions)} " +
        $"beaver_hazard_avoidance_updated_tick={FormatNumber(State.BeaverHazardAvoidanceLastUpdatedTick)} " +
